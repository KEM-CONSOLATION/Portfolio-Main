...
export default function SEO({
  ...
  description = "Portfolio of Consolation Lotachi Kem, a Senior Frontend Engineer with 5+ years of experience building scalable web applications with React, Next.js, and TypeScript.",
  keywords = [],
